...
echo ""
echo "NOTE: State directory /var/lib/${SERVICE_NAME}/ and user david-svc were NOT removed."
echo "      Remove manually if desired: rm -rf /var/lib/${SERVICE_NAME} && userdel david-svc"
echo ""
