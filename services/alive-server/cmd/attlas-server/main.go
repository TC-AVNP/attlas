...
func main() {
	...
	mux.HandleFunc("GET /api/homelab/nodes", handleHomelabNodes)
	mux.HandleFunc("GET /api/homelab/router-nodes", handleHomelabRouterNodes)
	mux.HandleFunc("GET /api/homelab/ssh-keys", handleHomelabSSHKeys)
