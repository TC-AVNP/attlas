#!/usr/bin/env bash
# Uninstall Builder's Knowledge Base
set -euo pipefail
...
echo ""
echo "NOTE: State directory /var/lib/${SERVICE_NAME}/ and user knowledge-svc were NOT removed."
echo "      Remove manually if desired: rm -rf /var/lib/${SERVICE_NAME} && userdel knowledge-svc"
echo ""
